...
description: Configure paths, terminal colors, diagnostics, and display settings through environment variables.
order: 330
section: Configure
---

Use environment variables for config discovery, terminal output, and diagnostics.
For persistent download options, use the [configuration file](../config).

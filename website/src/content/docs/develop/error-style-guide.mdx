...
description: Write actionable errors with consistent wording, output streams, exit codes, and diagnostics.
order: 630
section: Develop
---
...
`EXIT_INTERRUPTED`) — never bare integers. See [Exit Codes](../../reference/exit-codes/)
for failure categories and interrupt behavior.

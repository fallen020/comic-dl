---
title: Architecture
description: Follow the download pipeline, module boundaries, concurrency model, and extension points.
order: 610
section: Develop
---

Follow a URL from scraper selection to a verified archive and library record.
The source map below locates each stage; the [API reference](../../api-reference/)
indexes the modules used by plugin authors and contributors.
...
See [Security Testing](../security-testing/) for the offline test suite.

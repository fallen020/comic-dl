---
title: Testing
description: Run the offline test suite, find relevant tests, and check coverage when contributing.
order: 620
section: Develop
---

Run the **offline-only** suite when changing comic-dl. Use a single test file
for focused feedback, then the full suite before submitting a change.
...
See [Security Testing](../security-testing/) for coverage details.

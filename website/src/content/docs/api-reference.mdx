---
title: API Reference
description: Manually maintained index of comic_dl's public modules.
order: 220
...
[Architecture](../develop/architecture) first.
...
with [Writing a plugin](../usage/write-plugin) — this section documents the

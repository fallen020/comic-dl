...
description: Implement a source, return chapter and series metadata, and register a plugin package.
order: 450
section: Usage
---
...
the [example plugin package](https://github.com/fallen020/comic-dl/blob/main/examples/plugin-example/pyproject.toml).
...
See [Testing](../../develop/testing) for test commands and fixture conventions.

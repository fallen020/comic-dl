...
description: Find downloaded files, choose an archive format, and understand metadata, deduplication, and resume.
order: 420
section: Usage
---

Each series has its own output folder, with chapter archives and shared metadata.
Use the layout below to find files, then choose a container and compression mode.
...
See [Metadata](../metadata/) for the full field mapping.
...
days. See [Remove a series](../library/#remove-a-series) and
[Restore a series](../library/#restore-a-series) for the commands.

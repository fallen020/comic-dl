---
title: Metadata
description: See which ComicInfo.xml fields are written inside archives and beside them, with per-site mappings.
order: 430
section: Usage
---

comic-dl stores chapter and series metadata in `ComicInfo.xml`.

## Where metadata is written

The file appears in two places:

---
title: Plugins
description: Install and inspect third-party sources, validate plugins, and understand priority and trust boundaries.
order: 440
section: Usage
---
...
Follow [Writing a Plugin](../write-plugin/) for the source contract, result types,

...
description: List downloaded series, check recent chapters, update subscriptions, and remove or restore series.
order: 410
section: Usage
---
...
## Inspect chapters and file status
...
to detect breaking changes. See the [JSON output reference](../../reference/cli#json-output)
for payload shapes.

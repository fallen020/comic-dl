---
title: Exit Codes
description: Interpret process exit codes, classify failures, and handle interruptions or mixed batch results in scripts.
order: 510
section: Reference
---
...
Every `comic_dl.errors.ComicError` carries a stable machine-readable
...
end showing succeeded, skipped, and failed counts. For structured results,
see [JSON output](../cli/#json-output).
